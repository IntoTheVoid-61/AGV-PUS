#!/usr/bin/env python3
"""
Launch RViz visualization for the agv_pus robot.
...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/agv_pus/agv_pus_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/agv_pus_description/share/agv_pus_description/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='agv_pus',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'agv_pus_description'
    urdf_filename = 'agv_pus.urdf.xacro'
    rviz_config_filename = 'agv_pus_description.rviz'
