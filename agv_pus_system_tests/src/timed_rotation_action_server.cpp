 ...
 *
 * This program implements a ROS 2 action server that executes timed rotation actions for the AGV-PUS robot.
 ...
 *
 * Action Server:
 *   timed_rotation (agv_pus_msgs/action/TimedRotation):
...
#include "agv_pus_msgs/action/timed_rotation.hpp"
#include "geometry_msgs/msg/twist_stamped.hpp"

using namespace std::chrono_literals;
using TimedRotation = agv_pus_msgs::action::TimedRotation;
