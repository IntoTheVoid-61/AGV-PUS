#!/usr/bin/env python3
"""
Launch Nav2 for the AGV-PUS robot in Gazebo.
...
def generate_launch_description():
    ...
    """
    # Constants for paths to different packages, ti so kul
    package_name_docking = 'agv_pus_docking'
    package_name_gazebo = 'agv_pus_gazebo'
    package_name_localization = 'agv_pus_localization'
    package_name_navigation = 'agv_pus_navigation'

    # Launch and config file paths, tukaj popravi, pazi nav2_param_path
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/agv_pus.gazebo.launch.py'
    ...
    nav2_params_path = 'config/agv_pus_nav2_default_params.yaml'
    ...
    #    }.items()
    #)
    # Here are changes for different navigation package
